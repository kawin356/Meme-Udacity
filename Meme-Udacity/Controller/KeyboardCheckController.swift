...
extension MainViewController {
    ...
    func checkKeyboard() {
           NotificationCenter.default.addObserver(self, selector: #selector(MainViewController.keyboardScreenUp), name: UIResponder.keyboardWillShowNotification, object: nil)
